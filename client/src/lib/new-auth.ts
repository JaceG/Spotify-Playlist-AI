...
export async function redirectToSpotifyAuth() {
  ...
  // Use the exact redirect URI that's registered in Spotify Developer Dashboard
  const redirectUri = "https://3095b203-1854-4fe4-94cc-bec38e317854-00-1lcef2spkt33c.janeway.replit.dev/auth/spotify/callback";
  console.log("Redirecting with URI:", redirectUri);
...
export async function getAccessToken(code: string): Promise<string> {
  ...
  const redirectUri = "https://3095b203-1854-4fe4-94cc-bec38e317854-00-1lcef2spkt33c.janeway.replit.dev/auth/spotify/callback";
  console.log("Exchanging code with URI:", redirectUri);
